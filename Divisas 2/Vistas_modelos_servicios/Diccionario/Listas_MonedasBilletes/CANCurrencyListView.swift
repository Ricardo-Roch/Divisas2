...
struct CANCurrencyListView: View {
    ...
    var currencyItems: [CurrencyItem] {
        [
            // Monedas
            CurrencyItem(type: .coin, value: "0.05", displayName: "can_nickel".localized(), icon: "bitcoinsign.circle.fill"),
            CurrencyItem(type: .coin, value: "0.10", displayName: "can_dime".localized(), icon: "bitcoinsign.circle.fill"),
            CurrencyItem(type: .coin, value: "0.25", displayName: "can_quarter".localized(), icon: "bitcoinsign.circle.fill"),
            CurrencyItem(type: .coin, value: "0.50", displayName: "can_half_dollar".localized(), icon: "bitcoinsign.circle.fill"),
            CurrencyItem(type: .coin, value: "1", displayName: "can_loonie".localized(), icon: "bitcoinsign.circle.fill"),
            CurrencyItem(type: .coin, value: "2", displayName: "can_toonie".localized(), icon: "bitcoinsign.circle.fill"),
            
            // Billetes
            CurrencyItem(type: .bill, value: "5", displayName: "can_bill_5".localized(), icon: "banknote.fill"),
            CurrencyItem(type: .bill, value: "10", displayName: "can_bill_10".localized(), icon: "banknote.fill"),
            CurrencyItem(type: .bill, value: "20", displayName: "can_bill_20".localized(), icon: "banknote.fill"),
            CurrencyItem(type: .bill, value: "50", displayName: "can_bill_50".localized(), icon: "banknote.fill"),
            CurrencyItem(type: .bill, value: "100", displayName: "can_bill_100".localized(), icon: "banknote.fill")
        ]
    }
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                // Subtexto
                HStack {
                    Text("search_any_currency_canada".localized())
                        .font(.system(size: 14))
                        .foregroundColor(.appTextSecondary)
